<%-- Role-aware sidebar. Requires 'currentUser' (AdminUser) in session. --%>
...
<aside class="sidebar">
  ...
  <%-- Role badge --%>
  <div style="padding:8px 20px 12px;border-bottom:1px solid rgba(255,255,255,.08)">
  ...
  <%-- Audit Log — ADMIN and SUPER_ADMIN only --%>
