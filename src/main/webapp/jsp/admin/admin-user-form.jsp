...
<head>
    ...
    <title>
        ${empty editUser ? 'New Admin User' : 'Edit Admin User'} — Guacamole Admin
    </title>
    ...
    <div class="main">
        ...
        <jsp:include page="/jsp/layout/topbar.jsp">
            <jsp:param name="title"
                       value="${empty editUser ? 'New Admin User' : 'Edit Admin User'}"/>
        </jsp:include>
                    ...
                    <form method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   ${not empty editUser ? 
                                   'readonly style="background:#f5f7fb"' 
                                   : 'required'}
                        ...
                        <div class="form-group"
                            ...
                            <input type="checkbox"
                                   ...
                                   ${(empty editUser || editUser.active)
                                   ? 'checked'
                                   : ''}
